...
El problema de investigación se enmarca en el \textbf{objeto de estudio} los métodos para la integración semántica en la Web de datos almacenados de forma heterogénea y como \textbf{campo de acción} el método para integrar datos relativos al Control de Autoridades en el proyecto ELINF.
...
\hline 
Integración de los datos  & Fuentes integradas & Conceptos integrados \\
relativos al Control de Autoridades & & Estructura de la fuente \\ 
 \hline
\end{tabular} 
