...
\newcommand{\tituloTesis}{OntoIntegra: Método para la integración de datos almacenados en fuentes heterogéneas}
...
\newcommand{\fecha}{\large{noviembre de 2018}}
...
\newcommand{\ciudadFecha}{\large{\bf La Habana, \fecha}}
